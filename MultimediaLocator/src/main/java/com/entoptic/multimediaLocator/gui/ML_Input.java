...
//				display.window.chkbxDomeView.setEnabled(world.viewer.getSettings().orientationMode);
	...
	public void handleMousePressed(WMV_World world, ML_Display display, int mouseX, int mouseY, int frameCount)
	{
		mouse.handleMousePressed(world, display, mouseX, mouseY, frameCount);
	}
	
	public void handleMouseReleased(WMV_World world, ML_Display display, int mouseX, int mouseY, int frameCount)
	{
