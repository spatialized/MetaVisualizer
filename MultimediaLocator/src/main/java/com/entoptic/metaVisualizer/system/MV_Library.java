...
public class MV_Library 
{
	 ...
	 */
	public MV_Library(String newLibraryFolder)
	{
	 ...
	 */
	public boolean create(MetaVisualizer ml, ArrayList<String> mediaFolders)
	{
		if(ml.debug.library)
	 ...
	 */
	private void sortPanoramasFromImages(MetaVisualizer ml, ArrayList<String> files, String fieldFolder)
	{
...
//				System.out.println("Library.sortPanoramasFromImages()... file is panorama: "+fs);
	 ...
	 */
	private void sortImagesBySize(MetaVisualizer ml, ArrayList<String> files, String fieldFolder)
	{
		if(ml.debug.library) 
...
//							System.out.println("Library.createNewLibrary()... Image larger than 640 px: "+fs);
	 ...
	 * @param fieldFolder Field folder containing videos
	 */
	private void sortVideosBySize(MetaVisualizer ml, ArrayList<String> files, String fieldFolder)
	{
		if(ml.debug.library)
...
//			deleteFile(filePath);
	 ...
	 * @return
	 */
	public boolean sortAndCopyMedia(MetaVisualizer ml, String mediaFolder, String fieldFolder)
	{
		if(ml.debug.library)
