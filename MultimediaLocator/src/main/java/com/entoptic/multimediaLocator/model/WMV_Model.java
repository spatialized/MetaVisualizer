...
{
	/* General */
	public WMV_WorldSettings worldSettings;	// World settings
	public WMV_WorldState worldState;			// World state
	public WMV_ViewerSettings viewerSettings;	// Viewer settings
