...
import main.java.com.entoptic.multimediaLocator.metadata.WMV_SoundMetadata;
...
import main.java.com.entoptic.multimediaLocator.world.WMV_Viewer;
...
//	SoundFile sound;
	 ...
	 */
	public WMV_Sound ( int newID, int newType, WMV_SoundMetadata newSoundMetadata )
	{
...
//				player.clearInputConnections();
	 ...
	 */
	public void calculateLocationFromGPSTrack(ArrayList<WMV_Waypoint> gpsTrack, float soundGPSTimeThreshold)
	{
