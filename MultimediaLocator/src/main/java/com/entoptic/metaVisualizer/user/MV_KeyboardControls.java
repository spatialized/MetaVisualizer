 ...
 * @author davidgordon
 */
public class MV_KeyboardControls 
{
	private MV_Input input;
...
//	private boolean optionKey = false;
	 ...
	 * @param parent
	 */
	MV_KeyboardControls(MV_Input parent)
	{
		input = parent;
	}
	 ...
	 */
	public void handleUniversalKeyPressed(MetaVisualizer ml, char key, int keyCode)
	{
		if(ml.debug.input)
		{
...
//				optionKey = true;
	 ...
	 * @param keyCode
	 */
	public void handleAllViewsKeyPressed(MetaVisualizer ml, char key, int keyCode)
	{
		if(ml.debug.input)
		{
			if(key == PApplet.CODED)
...
//				ml.world.incrementTimeCycleLength();
	 ...
	 * @param keyCode Key code
	 */
	public void handleMapViewKeyPressed(MetaVisualizer ml, char key, int keyCode)
	{
		if (key == 's') 
...
//			ml.world.exportCurrentView();
	 ...
	 * @param keyCode
	 */
	public void handleMapViewKeyReleased(MetaVisualizer ml, char key, int keyCode)
	{
...
//			}
	 ...
	 * @param keyCode
	 */
	public void handleTimeViewKeyReleased(MetaVisualizer ml, char key, int keyCode)
	{
		/* Navigation */
		if (key == 'j') 
	 ...
	 * @param keyCode
	 */
	public void handleLibraryViewKeyReleased(MetaVisualizer ml, char key, int keyCode)
		{
		if (key == 'j') 
			ml.world.viewer.moveToRandomCluster(true, false);				/* Teleport to random cluster */
...
//		}
	 ...
	 * @param keyCode
	 */
	public void handleTimeViewKeyPressed(MetaVisualizer ml, char key, int keyCode)
	{
		if (key == PApplet.CODED) 					
		{
	 ...
	 * @param keyCode Key code
	 */
	public void handleMediaViewKeyReleased(MetaVisualizer ml, char key, int keyCode)
	{
		if(key == PApplet.ENTER)
...
//			ml.display.window.closeListItemWindow(false);
	 ...
	 * @param keyCode Key code
	 */
	public void handleAllViewsKeyReleased(MetaVisualizer ml, MV_Display display, char key, int keyCode)
	{
		if(ml.debug.input)
		{
			if(key == PApplet.CODED)
...
//				optionKey = false;
	 ...
	 * @param keyCode Key code
	 */
	public void handleInteractiveClusteringKeyPressed(MetaVisualizer ml, char key, int keyCode)
	{
//		if (!optionKey && key == 'h')
		if (key == 'h')
		{
